...
public class SnakePanel extends JPanel {
	...
	//TODO crear variables staticas que tengan el ancho y alto del panel. Ademas cuantos pixels por cuadro
    ...
    public boolean invincible;//TODO snakecontroller o gamecontroller
        ...
        public void run() {
            try {
                while (estaVivo) {
                    ...
                    if (laberinto != null) {
                        if (!invincible && laberinto.esta(x, y)) { //todo remove
                            estaVivo = false;
                        }
                    }
                    if (!invincible && snake.crashOwnBody(x, y)) {
                        estaVivo = false;
                    }
